...
$sentencia = $pdo->prepare("SELECT * FROM tblventas WHERE ClaveTransaccion LIKE '%$category%' or Fecha LIKE '%$category%' or nombre like '%$category%' or status LIKE '%$category%'");
$sentencia->execute();
