...
$sentencia = $pdo->prepare("SELECT * FROM tblusuarios WHERE nombre LIKE '%$category%' or correo LIKE '%$category%' or usuario LIKE '%$category%'");
$sentencia->execute();
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <?php foreach($listaUsuarios as $producto) { ?>
                    ...
                    <input type="hidden" name="id" value="<?php echo $producto['id']; ?>" > 
                      ...
                      <td><center><?php echo $producto['correo'];?></center></td>
