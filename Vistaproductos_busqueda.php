...
$sentencia = $pdo->prepare("SELECT * FROM tblproductos WHERE nombre LIKE '%$category%' or categoria LIKE '%$category%' or id LIKE '%$category%'");
$sentencia->execute();
...
switch ($accion) {
  ...
  case "btnModificar":
    ...
    if ($tmpFoto != "") {
      ...
      $sentencia = $pdo->prepare("UPDATE tblproductos SET foto=:foto WHERE id=:id ");
      $sentencia->bindParam(':foto', $nombreArchivo);
      $sentencia->bindParam(':id', $txtID);
      $sentencia->execute();
    }
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <!-- <button class="btn btn-outline-warning" <?php //echo $accionModificar; 
                                                                    ?> value="btnModificar" type="submit" name="accion">Modificar</button>
                      <button class="btn btn-outline-danger" <?php //echo $accionEliminar; 
                                                              ?> value="btnEliminar" type="submit" name="accion">Eliminar</button>-->
                      <!--<button class="btn btn-outline-info" <?php echo $accionCancelar; ?> value="btnCancelar" type="submit" name="accion">Cancelar</button>-->
                    </div>
                  </div>
                </div>
              </div>
